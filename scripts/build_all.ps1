...
Move-Item "dist\像素译站.exe" "dist\便携版\release-v1.2.3-portable.exe"
Write-Host "  onefile 已移动到: dist\便携版\release-v1.2.3-portable.exe"
...
if ($iscc) {
    ...
    Write-Host "  安装版产物: dist\安装版\release-v1.2.3-setup.exe"
} else {
...
Write-Host "=============================================="
Write-Host "全部完成！"
Write-Host "  安装版: dist\安装版\release-v1.2.3-setup.exe（需 Inno Setup 6）"
Write-Host "  便携版: dist\便携版\release-v1.2.3-portable.exe"
